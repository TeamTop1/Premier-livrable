...
int main (int argc, char**argv) {
    //Var
    int numCase, numCaseD, choix, sauv, max, a, i, j, point_jaune, point_rouge, point_rouge5, point_jaune5, compteur, def,test;
    int colonne_ad[9];
    FILE *fp;
    ...
    switch (max)
    {
        case 1:
            ...
            stpcpy(filename, "/var/www/html/avalam-web/initial.json");
            break;
        case 2:
...
void menu1(int *choix)
{
    viderBuffer();
    puts("======MENU ERREUR======");
    puts("1) Utiliser le FEN par defaut");
...
void menu2(int *choix)
{
    ...
    puts("2) Utiliser la description par defaut");
    puts("============================");
    scanf("%d",choix);
}
